...
https://raw.githubusercontent.com/umpirsky/country-list/master/data/ar/country.json
https://raw.githubusercontent.com/umpirsky/country-list/master/data/ar_SA/country.json

https://raw.githubusercontent.com/AndroidUpscale/RainRadarUpscale/master/country_ar.json
___*/
        const countryNamesESRes = await fetch("https://raw.githubusercontent.com/AndroidUpscale/RainRadarUpscale/master/country_ar.json");
...
function updateInfoCards(globalData, countriesData, countryNamesES) {
    ...
    countriesData.forEach((country, i) => {
        ...
        spanCasos.textContent = country.cases.toLocaleString('ar');
    ...
    divLastUpdated.textContent = new Date(globalData.updated).toLocaleString('ar', { hour12: true });
