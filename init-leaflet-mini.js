...
function playStopAnimation() {
    document.getElementById("button-play").value = animation ? "fa fa-play" : "fa fa-pause ", animation ? stopAnimation() : playAnimation(), isAutoPlay = animation ? 1 : 0, sC("autoplay", isAutoPlay), ev("autoplay")
}
...
var mapType = getParamFromUrlCookie("rmt",
    "rmt",
    3);
"roadmap" == mapType ? mapType = 0 : "hybrid" == mapType ? mapType = 1 : "rain_viewer" == mapType ? mapType = 2 : (mapType < 0 || mapType > 4) && (mapType = 0);
var layerBaseMap,
    layerReferenceMap,
    map,
    coverageLayer,
